...
import edu.uoc.pelp.model.dao.StatisticsDAO;
import java.io.File;
import java.net.URL;
...
/**
 * Implements the DAO object for the Statistical data. 
 * @author Xavier Baró
 */
public class LocalStatisticsDAO extends StatisticsDAO {
    
    private LocalDAO _localDAO=null;
    
    /**
     * Creates a new LocalStatisticsDAO object from given Hibernate SessionFactory
     * @param sessionFactory SessionFactory object
     */
    public LocalStatisticsDAO(SessionFactory sessionFactory) {
    ...
    /**
     * Creates a new LocalStatisticsDAO object from given Hibernate configuration resource
     * @param resource Resource with configuration for Hibernate Database Connection
     */
    public LocalStatisticsDAO(String resource) {
        // Call parent constructor
        super();
    ...
    /**
     * Creates a new LocalStatisticsDAO object from given Hibernate configuration file
     * @param confFile File with configuration for Hibernate Database Connection
     */
    public LocalStatisticsDAO(File confFile) {
        // Call parent constructor
        super();
    ...
    /**
     * Creates a new LocalStatisticsDAO object from given Hibernate configuration url
     * @param url URL with configuration for Hibernate Database Connection
     */
    public LocalStatisticsDAO(URL url) {
        // Call parent constructor
        super();
